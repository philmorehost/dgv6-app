...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText etPass, @NonNull EditText etUser, @NonNull ProgressBar progressBar,
      @NonNull TextView tvDomain, @NonNull TextView tvRegister) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnLogin, etPass, etUser,
          progressBar, tvDomain, tvRegister);
    }
